...
var digit_20361 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_20362__$1 = (vlq >>> (5));
while(true){
if((vlq_20362__$1 > (0))){
var digit_20363__$1 = (digit_20361 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_20363__$1));

var G__20364 = (vlq_20362__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__20365 = (vlq_20362__$1 >>> (5));
digit_20361 = G__20364;
vlq_20362__$1 = G__20365;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_20361));
}
break;
}
...
var G__20366 = i__$1;
var G__20367 = result__$1;
var G__20368 = shift__$1;
i = G__20366;
result = G__20367;
shift = G__20368;
continue;
