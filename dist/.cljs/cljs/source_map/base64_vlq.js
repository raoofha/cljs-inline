...
var digit_20411 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_20412__$1 = (vlq >>> (5));
while(true){
if((vlq_20412__$1 > (0))){
var digit_20413__$1 = (digit_20411 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_20413__$1));

var G__20414 = (vlq_20412__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__20415 = (vlq_20412__$1 >>> (5));
digit_20411 = G__20414;
vlq_20412__$1 = G__20415;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_20411));
}
break;
}
...
var G__20416 = i__$1;
var G__20417 = result__$1;
var G__20418 = shift__$1;
i = G__20416;
result = G__20417;
shift = G__20418;
continue;
