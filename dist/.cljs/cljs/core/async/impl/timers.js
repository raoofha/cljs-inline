...
var self__ = this;
var coll__$1 = this;
var x__12697__auto__ = self__.key;
return cljs.core._conj((function (){var x__12697__auto____$1 = self__.val;
...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__12414__auto__,writer__12415__auto__,opt__12416__auto__){
return cljs.core._write(writer__12415__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_24447 = (0);
while(true){
if((i_24447 < arr.length)){
(arr[i_24447] = null);

var G__24448 = (i_24447 + (1));
i_24447 = G__24448;
continue;
} else {
}
...
var i_24457 = (self__.level + (1));
while(true){
if((i_24457 <= (new_level + (1)))){
(update[i_24457] = self__.header);

var G__24458 = (i_24457 + (1));
i_24457 = G__24458;
continue;
} else {
}
...
var i_24459 = (0);
while(true){
if((i_24459 <= self__.level)){
var links_24460 = (update[i_24459]).forward;
if((x__$1 === (((i_24459 < links_24460.length))?(links_24460[i_24459]):null))){
(links_24460[i_24459] = (x__$1.forward[i_24459]));

var G__24461 = (i_24459 + (1));
i_24459 = G__24461;
continue;
} else {
var G__24462 = (i_24459 + (1));
i_24459 = G__24462;
continue;
}
} else {
...
if(!((nx == null))){
var G__24464 = nx;
var G__24465 = (level__$1 - (1));
x = G__24464;
level__$1 = G__24465;
continue;
} else {
var G__24466 = x;
var G__24467 = (level__$1 - (1));
x = G__24466;
level__$1 = G__24467;
continue;
}
...
var G__24469 = nx;
var G__24470 = (level__$1 - (1));
x = G__24469;
level__$1 = G__24470;
continue;
} else {
var G__24471 = x;
var G__24472 = (level__$1 - (1));
x = G__24471;
level__$1 = G__24472;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__12414__auto__,writer__12415__auto__,opt__12416__auto__){
return cljs.core._write(writer__12415__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__11743__auto__ = (cljs.core.truth_((function (){var and__11731__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__11743__auto__,timeout,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__11743__auto__,timeout,me))
,msecs);
