...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__12433__auto__,k18686,else__12434__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18686,else__12434__auto__);
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18685){
var self__ = this;
var G__18685__$1 = this;
return (new cljs.core.RecordIter((0),G__18685__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$splicing_QMARK_,cljs.core.cst$kw$form], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__12199__auto____$1 = (function (){var fexpr__18691 = ((function (h__12199__auto__,this__12427__auto____$1){
...
;
return fexpr__18691(this__12427__auto____$1);
})();
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18687,other18688){
var self__ = this;
var this18687__$1 = this;
return (!((other18688 == null))) && ((this18687__$1.constructor === other18688.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18687__$1.splicing_QMARK_,other18688.splicing_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18687__$1.form,other18688.form)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18687__$1.__extmap,other18688.__extmap));
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__12438__auto__,k__12439__auto__,G__18685){
var self__ = this;
var this__12438__auto____$1 = this;
var pred__18692 = cljs.core.keyword_identical_QMARK_;
var expr__18693 = k__12439__auto__;
if(cljs.core.truth_((function (){var G__18695 = cljs.core.cst$kw$splicing_QMARK_;
...
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__18685,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18697 = cljs.core.cst$kw$form;
...
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__18685,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__12439__auto__,G__18685),null));
}
}
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__12430__auto__,G__18685){
var self__ = this;
var this__12430__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__18685,self__.__extmap,self__.__hash));
});
...
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__18689){
return (new cljs.tools.reader.impl.utils.ReaderConditional(cljs.core.cst$kw$splicing_QMARK_.cljs$core$IFn$_invoke$arity$1(G__18689),cljs.core.cst$kw$form.cljs$core$IFn$_invoke$arity$1(G__18689),null,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18689,cljs.core.cst$kw$splicing_QMARK_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$form], 0))),null));
});
...
var iter__12625__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__18700(s__18701){
return (new cljs.core.LazySeq(null,(function (){
var s__18701__$1 = s__18701;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__18701__$1);
if(temp__5457__auto__){
var s__18701__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__18701__$2)){
var c__12623__auto__ = cljs.core.chunk_first(s__18701__$2);
var size__12624__auto__ = cljs.core.count(c__12623__auto__);
var b__18703 = cljs.core.chunk_buffer(size__12624__auto__);
if((function (){var i__18702 = (0);
while(true){
if((i__18702 < size__12624__auto__)){
var key = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__12623__auto__,i__18702);
cljs.core.chunk_append(b__18703,((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__18704 = (function (){var fexpr__18707 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__18707.cljs$core$IFn$_invoke$arity$1 ? fexpr__18707.cljs$core$IFn$_invoke$arity$1(key) : fexpr__18707.call(null,key));
})();
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18704,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18704,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18703),cljs$tools$reader$impl$utils$namespace_keys_$_iter__18700(cljs.core.chunk_rest(s__18701__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18703),null);
}
} else {
var key = cljs.core.first(s__18701__$2);
return cljs.core.cons(((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__18708 = (function (){var fexpr__18711 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__18711.cljs$core$IFn$_invoke$arity$1 ? fexpr__18711.cljs$core$IFn$_invoke$arity$1(key) : fexpr__18711.call(null,key));
})();
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18708,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18708,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return (__GT_key.cljs$core$IFn$_invoke$arity$2 ? __GT_key.cljs$core$IFn$_invoke$arity$2(ns,key_name) : __GT_key.call(null,ns,key_name));
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__18700(cljs.core.rest(s__18701__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__18713){
var vec__18714 = p__18713;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18714,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18714,(1),null);
